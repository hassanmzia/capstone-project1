...
class CNEAv5(QObject):
    def __init__(self, bitstreamFile):
        ...
        self.data_into_16bits = array.array('H')
    ...
    def pipe_out_block(self, bank, data_length):
        ...
        # data_pipe = bytearray(data_length*4)
        self.xem.ReadFromBlockPipeOut(bank, 2048, self.data_pipe)
        data_temp = np.reshape(self.data_pipe,(-1,2))    
        data_temp = (data_temp[::, 0] + 256 * (data_temp[::, 1]%16)) # first 8 LSBs + 4 MSBs
        # print(len(self.data_pipe))
        # self.data_into_16bits.clear()
        # self.data_into_16bits.frombytes(self.data_pipe)
        # print('ff')
        # print(len(self.data_into_16bits))
        return data_temp
        # return self.data_into_16bits
    ...
    def data_stream_init(self):
        ...
        if self.recording_enable:
            ...
            self.data_raw = root.zeros('raw', shape=(0, 4096), chunks = (512, 1), dtype='uint16') # type: ignore
    ...
    def data_stream_ic_ddr3(self,data_length):
        ...
        data_temp = np.reshape(datain, (512, 4096))
